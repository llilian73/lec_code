...
def process_all_cases():
    """按年份和case批量处理地图和汇总数据"""
    base_dir = r"Z:\local_environment_creation\energy_consumption\2016-2020result"
    shapefile_path = r"Z:\local_environment_creation\shapefiles\全球国家边界\world_border2.shp"
    output_base = r"Z:\local_environment_creation\energy_consumption\2016-2020result\figure maps\per_capita"
    ...
    for year in years:
        ...
        for case_num in range(1, 21):  # case1到case20
            print(f"  Case {case_num} 地图绘制和数据汇总...")
            ...
            if combined_data:
                ...
                print(f"    汇总数据已保存到: {csv_output_path}")

def main():
    print("开始绘制世界地图...")
    process_all_cases()
    print("\n所有地图和数据汇总完成！")
    print("地图输出结构: figure maps/{year}/")
    print("汇总数据输出结构: figure maps/data/{year}/")

...
def plot_average_map(avg_data, shapefile_path, save_path, case_num, code2_to_code3):
    ...
    for col, cmap_key in data_types:
        ...
        world.plot(column='value',
                   ...
                   legend=True,
                   legend_kwds={'label': f'{cmap_key.capitalize()} Demand Difference (TWh)',
        ...
        plt.title(f'{cmap_key.capitalize()} Demand Difference (TWh) - Case {case_num} - 5-Year Average', fontsize=16)
        ax.axis('off')

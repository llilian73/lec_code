...
def plot_stacked_bars(heating_data, cooling_data, total_data, title, save_pdf_path):
    ...
    case_colors = {
        'ref': '#E5E5E5',#'#E5E5E5',     # 浅灰
        'case1': '#F1C3C1',#'#6C7F93',   # 灰蓝
        'case2': '#B7D5EC',#'#7FA1D5',   # 浅蓝
        'case3': '#FEDFB1',#'#E79B6B',   # 橙色
        'case4': '#B9C3DC',#'#F2C757',   # 黄色
        'case5': '#B2D3A4',#'#98C279',   # 浅绿
    }
    ...
    # 设置坐标轴标签
    ax.set_xlabel(r'$T_{expansion}(\degree C)$', fontsize=18, labelpad=15)

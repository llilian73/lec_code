...
def calculate_global_energy(is_per_capita=True):
    ...
    # 设置基础路径
    base_paths = {
        'global': r"Z:\local_environment_creation\energy_consumption_gird\result\result"
    }
    ...
    # 合并所有年份的数据并保存
    output_dir = r"Z:\local_environment_creation\energy_consumption_gird\result\result\global_total_energy_demand"

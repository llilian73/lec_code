    ...
    for base_path in base_paths:
        ...
        for file in files:
            ...
            try:
                ...
                # 读取总能耗数据
                total_val = pd.to_numeric(case_data.get('total_demand_sum(TWh)', np.nan), errors='coerce')
                heating_val = pd.to_numeric(case_data.get('heating_demand_sum(TWh)', np.nan), errors='coerce')
                cooling_val = pd.to_numeric(case_data.get('cooling_demand_sum(TWh)', np.nan), errors='coerce')

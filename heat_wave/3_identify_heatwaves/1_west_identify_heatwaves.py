...
def main():
    ...
    csv_files = glob.glob(
        r"Y:\CMIP6\Energy consumption in heat wave code\Historical tasmax\west\point_lat*_lon*.csv")  # 作为参考期数据来源
    ...
    for target_year_str in target_years:
        ...
        output_file = os.path.join(output_dir, f"{target_year_str}_all_heat_wave_west.csv")

...
CHINA_BOUNDS = {
    ...
    'lat_max': 90.0,
    'lon_min': 0.0,  # 修改为0.0
    'lon_max': 180.0  # 修改为180.0
}

# 设置气候数据路径
climate_base_path = r"Y:\CMIP6\future"  # 修改为你的气候数据路径

# 设置输入点文件路径（CSV）
point_file = r"C:\Users\thuarchdog\PycharmProjects\PythonProject\output_2030\2030_all_heat_wave_east.csv"
population_file = r"C:\Users\thuarchdog\PycharmProjects\PythonProject\population\East_population.csv"

# 设置输出路径
output_dir = r"C:\Users\thuarchdog\Desktop\result\EAST_output_all_heat_wave"
...
class SharedClimateData:
    ...
    def load_all_data(self):
        ...
        # 定义文件路径
        self.tas_file = os.path.join(climate_base_path, "tas_day_EC-Earth3-HR_ssp245_r1i1p1f1_gr_20300101-20301231.nc")
        self.rsds_file = os.path.join(climate_base_path, "rsds_day_EC-Earth3-HR_ssp245_r1i1p1f1_gr_20300101-20301231.nc")
        self.huss_file = os.path.join(climate_base_path, "huss_day_EC-Earth3-HR_ssp245_r1i1p1f1_gr_20300101-20301231.nc")
        self.uas_file = os.path.join(climate_base_path, "uas_day_EC-Earth3-HR_ssp245_r1i1p1f1_gr_20300101-20301231.nc")
        self.vas_file = os.path.join(climate_base_path, "vas_day_EC-Earth3-HR_ssp245_r1i1p1f1_gr_20300101-20301231.nc")
        # 加载第一个文件来获取时间和坐标信息
